...
# Dataset
Our dataset is publicly available through Kaggle, called the Screen Time, Sleep & Stress Analysis Dataset. The dataset has already been cleaned and processed, specifically with no missing values, a clean structured format, and balanced categorical features.
